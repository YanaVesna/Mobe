    ...
    <>
      ...
      <div className="productCard">
        <div className="accessories__container">
          ...
          <div className="accessories__menu">
            <a
          ...
          <div
            ...
            className="accessories__cardBox"
          >
            <div className="accessories__card1">
              {!mobile ? (
                <SwiperSlider1 model={colorActive} />
              ) : (
                <SwiperSlider2 colorActive={colorActive} />
              )}
            </div>
            <div className="accessories__cardPart3">
              {about ? titleProduct2() : ""}
              <div className="accessories__cardBlock1">
                <div className="accessories__cardBlock11">
                  <p>
                    Color: <span>{characteristic.color}</span>
                  </p>
                  <div
                    style={!desktop ? { display: "flex" } : { display: "none" }}
                    className="accessories__cardBlockLeft"
                  >
                    <div className="accessories__PCbox">
                      <IconsHeart
                ...
                <div className="accessories__colors">
                  <div
                    onClick={() => setColorActive(2)}
                    className="accessories__color2"
                  >
                    {colorActive === 2 ? <IconTick /> : ""}
                  </div>
                </div>
              </div>
              <div className="accessories__shot-Characteristics">
                <h6>Main characteristics</h6>
                <p>
                  Compatible model:<span> Apple iPhone 14 Pro</span>
                </p>
                <p>
                  Form factor:<span> overlay</span>
                </p>
                <p>
                  Material: <span> Silicon</span>
                </p>
              </div>

              <div className="accessories__cardBlock2">
                <div
                  style={desktop ? { display: "flex" } : { display: "none" }}
                  className="accessories__cardBlockLeft"
                >
                  <div className="accessories__cardBlockLeft-tip">
                    <svg
                ...
                <div className="accessories__cardBlockRight">
                  <div className="accessories__cardBlockPart1">
                    <p>
                      $
                      {activeAnalog === analogCard.name
                        ? analogCard.price
                    ...
                    <div className="accessories__cardBlockEconomy">
                      <p>Economy:</p>
                      <p>- $ 100</p>
                    </div>
                  </div>
                  <div className="accessories__cardBlockPart2">
          ...
          <div className="accessories__titleBox">
            {characteristic2 || reviews ? title() : ""}
            <div className="accessories__rating-box">
          ...
          <div
            ...
            className={
              characteristic2 || reviews
                ? "accessories__cardBox2"
                : "accessories__cardBox"
            }
          >
            {characteristic2 && desktop
              ? isProductCardVisible && (
                  <div
                    ...
                    className="accessories__absoluteDesktop"
                  >
                    <div className="accessories__container">
                      <ProductCardBox
          ...
          <div
            ...
            className="accessories__sort-box"
          >
            <button
          ...
          <div
            style={reviews ? { display: "flex" } : { display: "none" }}
            className="accessories__cardBox3"
          >
            {reviews && desktop
              ? isProductCardVisible && (
                  <div
      ...
      {(characteristic2 || reviews) && !desktop
        ? isProductCardVisible && (
            <div
              id="yourProductCardID"
              className="accessories__absoluteMobileTablet"
            >
              <ProductCardBox />
            </div>
          )
